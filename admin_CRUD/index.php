<?php
require_once("../admin_CRUD/PHP/component.php");
require_once("../admin_CRUD/PHP/operation.php");


session_start();
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] != true) {
    header('location: ../Signup/AUTH/index.php');
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="../admin_CRUD/style.css">
...
<body>
    <main>
        <div class="container text-center">
            <h1 class="py-4 bg-dark text-light rounded"><i class="fas fa-warehouse"></i> Data Entry Tool (DET) <i class="fas fa-warehouse"></i></h1>
            <div class="d-flex justify-content-center">
                <form action="" method="POST" class="w-50">
                    <div class="py-2">
                        <a style="color: #000 !important;text-decoration: none;" class="po-back" href="../Signup/AUTH/admin_Welcome.php"> <i class="fas fa-arrow-left"></i> Back</a>
                    ...
                    <div class="d-flex justify-content-center">
                        <?php buttonElement('btn-create', 'btn btn-success', '<i class="fas fa-plus"></i>', 'Register', "data-toggle='tooltip' data-placement='bottom' title='Register Property'"); ?>
                        <?php buttonElement('btn-read', 'btn btn-primary', '<i class="fas fa-sync-alt"></i>', 'Read', "data-toggle='tooltip' data-placement='bottom' title='Search Property'"); ?>
    ...
    <script src="../admin_CRUD/PHP/main.js"></script>
</body>
