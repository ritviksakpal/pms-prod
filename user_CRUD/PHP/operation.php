...
function createData()
{
    ...
    if ($location && $price && $area && $possession) {
        $sql = "
                INSERT INTO property(location, price, area, possession)
                VALUES('$location','$price','$area','$possession')
        ";
...
function UpdateData(){
    ...
    if($location && $price && $area && $possession){
        $sql = "
                    UPDATE property SET location='$location', price = '$price', area = '$area',  possession='$possession' WHERE id='$id';                    
        ";
