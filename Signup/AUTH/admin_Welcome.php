        ...
        <div class=" inner-nav container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="">Raw Data</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="../../admin_CRUD/index.php">DET</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="">User Data</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="../../Signup/AUTH/admin_logout.php">Log out</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <main>
        <div style="height: 85vh;" class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
            <div class="col-md-5 p-lg-5 mx-auto my-5">
                <h1 class="blockquote text-center">Welcome - Admin </h1>
